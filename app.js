...
function viewRoles() {
  db.query({ sql: "SELECT * FROM roles" }, (errors, results, fields) => {
    if (errors) {
      console.log(errors.message);
    }
    console.table(results);
...
function viewEmployees() {
  db.query({ sql: "SELECT * FROM employees" }, (errors, results, fields) => {
    if (errors) {
      console.log(errors.message);
    }
    console.table(results);
    ...
    .prompt([
      {
        ...
        name: "employeeId",
        message:
          "What is the ID of the employee whose role you would like to change?",
      },
      {
        type: "input",
        name: "newRole",
